...
@pytest.fixture(scope='session')
async def farm_factory(account_factory):
    ...
    print('StarkVile')
    starkvile = await starknet.deploy(
        source="contracts/starkvile/StarkVile.cairo",
        constructor_calldata=[],
    )
    
    # print('StarkVile Proxy')
    # proxy_starkvile = await starknet.deploy(
    #     source="contracts/starkvile/proxy/PROXY_StarkVile.cairo",
    #     constructor_calldata=[starkvile.contract_address],
    # )

    # print('StarkVile init')
    # await admin_key.send_transaction(
    #     account=admin_account,
    #     to=proxy_starkvile.contract_address,
    #     selector_name='initializer',
    #     calldata=[admin_account.contract_address],
    # )
    return admin_account, admin_key, starkvile, starknet
